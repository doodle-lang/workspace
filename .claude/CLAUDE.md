...
- `discussions/plan/implementation.md` — Implementation plan: architecture decisions (AD1–AD8), milestones (M0–M10), spec-reconciliation backlog (Appendix C, S-1…S-44), open decisions (§10)
